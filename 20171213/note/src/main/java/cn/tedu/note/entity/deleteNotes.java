...
public class deleteNotes implements Serializable {
	
	String cn_note_id;
	String cn_notebook_id;
	String cn_note_title;
	String cn_note_body;
	String cn_user_id;
	String cn_note_status_id;
	String cn_type_id;
	Long cn_note_create_time;
	...
	public deleteNotes(String cn_note_id, String cn_notebook_id, String cn_note_title, String cn_note_body,
			String cn_user_id, String cn_note_status_id, String cn_type_id, Long cn_note_create_time,
			Long cn_note_last_modify_time) {
		super();
	...
	public String getCn_type_id() {
		return cn_type_id;
	}
	public void setCn_type_id(String cn_type_id) {
		this.cn_type_id = cn_type_id;
	}
	...
	public String toString() {
		return "deleteNotes [cn_note_id=" + cn_note_id + ", cn_notebook_id=" + cn_notebook_id + ", cn_note_title="
				+ cn_note_title + ", cn_note_body=" + cn_note_body + ", cn_user_id=" + cn_user_id
				+ ", cn_note_status_id=" + cn_note_status_id + ", cn_type_id=" + cn_type_id + ", cn_note_create_time="
