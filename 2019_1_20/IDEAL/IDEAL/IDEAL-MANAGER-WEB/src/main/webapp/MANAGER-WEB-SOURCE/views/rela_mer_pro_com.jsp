                ...
                <div class="tpl-block">
                    ...
                    <div id="showTable">
                        <div id="toolbar">
                            ...
                            <button onclick="allowed()" id="-good" class="btn btn-default" type="button" style="margin-right: 5px;float: left;border-top-left-radius: 0%;border-bottom-left-radius: 0%;border-left:0;">
                                通过
                            </button>
