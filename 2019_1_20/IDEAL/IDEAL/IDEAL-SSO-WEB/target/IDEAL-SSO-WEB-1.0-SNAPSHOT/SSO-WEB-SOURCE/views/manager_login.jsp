...
<div class="am-g myapp-login">
    <div class="myapp-login-logo-block  tpl-login-max" style="margin-top: 200px">
        <div class="myapp-login-logo-text">
            <div class="myapp-login-logo-text">
                IDEAL-MANAGER<span> Login</span> <i class="am-icon-skyatlas"></i>
...
<script>
    $('#submit').click(function() {
        $.ajax({
            ...
            success: function (data, status) {
                console.log(data);
                window.location.href = "http://localhost:8082/commodity_category";
            },
            error: function () {
                alert('登陆失败');
            }
    ...
    $("#SignUp").click(function () {
        window.location.href = "http://localhost:8088/manager_register";
    });
    $("#LogIn").click(function () {
        window.location.href = "http://localhost:8088/manager_login";
    });
</script>
</body>
