...
<div class="site-topbar">
    <div class="container">
        <div class="topbar-nav">
            ...
            <a rel="nofollow" href="https://b.mi.com/?client_id=180100031058&masid=17409.0358" target="_blank">政企服务</a><span class="sep">|</span>
            <a rel="nofollow" href="https://www.mi.com/aptitude/list/?id=41" target="_blank">资质证照</a><span class="sep">|</span>
            <a rel="nofollow" href="https://www.mi.com/aptitude/list/" target="_blank">协议规则</a><span class="sep">|</span>
            <a rel="nofollow" href="//www.mi.com/appdownload/" target="_blank" id="J_downloadapp">下载app</a><span class="sep">|</span>
            <a rel="nofollow" href="#J_modal-globalSites" data-toggle="modal">Select Region</a>
        </div>
        <div class="topbar-cart" id="J_miniCartTrigger">
            <a rel="nofollow" class="cart-mini" id="J_miniCartBtn" href="//static.mi.com/cart/"><i class="iconfont">&#xe60c;</i>购物车<span
                ...
                <div class="J_main">
                    ...
                    <div class="J_addressWrap address-wrap">
                        <div class="user-default-address" id="J_userDefaultAddress"><i
                            ...
                            <div class="product-status soldout" id="J_productStatus"><span class="init">正在加载...</span></div>
                        </div>
                    </div>
                    <!-- 产品版本 -->
                    <div class="list-wrap" id="J_list">
                        <c:forEach items="${spes.data}" var="t" varStatus="status">
                            <div class="pro-choose pro-choose-col2 J_step" >
                                ...
                                <ul class="step-list clearfix" data-index="${status.index}" data-id="${spes.default_data[status.index]}" data-value="">
                                    <c:forEach items="${t.value}" var="i">
                                        <li class="btn btn-biglarge" data-id="${i.id}" data-index="${status.index}" data-value="${i.value}">
                        ...
                        <div class="pro-choose list-choose list-choose-small J_service" data-index="0"
                             data-multi="false">
                            <div class="step-title"> 选择小米提供的延长保修 <a href="https://api.jr.mi.com/activity/accidentIns/?from=mishop&amp;insuranceSku=22609" target="_blank">了解延长保修 &gt;</a>
                            </div>
                            <ul>
                        ...
                        <div class="pro-choose list-choose list-choose-small J_service" data-index="1"
                             data-multi="false">
                            <div class="step-title"> 选择小米提供的意外保护 <a href="https://api.jr.mi.com/activity/accidentIns/?from=mishop&amp;insuranceSku=22607" target="_blank">了解意外保护 &gt;</a></div>
                            <ul>
                                <li class="clearfix" data-oriprice="399.00" data-price="399.00" data-name="意外保障服务" data-bargain_id="2185000003" data-id="2185000003" data-source="common"><i class="iconfont icon-checkbox"><em>√</em></i> <img src="//i1.mifile.cn/a1/pms_1544513128.60258716.jpg?width=50&amp;height=50">
                                    <div><span class="name"> 意外保障服务   </span>
                                        <p class="desc">小米MIX3故宫版 意外保障服务</p>
                                        <p class="agreement">
                                            <i class="iconfont icon-checkbox J_read"><em>√</em></i>
                                            我已阅读
                                            <a href="https://api.jr.mi.com/insurance/document/phone_accidentIns.html?insuranceSku=22607&amp;couponFrom=rule" target="_blank">服务条款<span>|</span></a>
                                            <a href="https://api.jr.mi.com/insurance/document/phone_accidentIns.html?insuranceSku=22607&amp;couponFrom=question" target="_blank">常见问题</a>
                                        </p>
                                        <span class="price">  399元  </span>
                                    </div>
                                </li>
                                <li class="clearfix" data-oriprice="199.00" data-price="199.00" data-name="碎屏保障服务" data-bargain_id="2185000004" data-id="2185000004" data-source="common"><i class="iconfont icon-checkbox"><em>√</em></i> <img src="//i1.mifile.cn/a1/pms_1544513237.11031355.jpg?width=50&amp;height=50">
                                    <div>
                                        <span class="name"> 碎屏保障服务   </span>
                                        <p class="desc">小米MIX3故宫版 碎屏保障服务</p>
                                        <p class="agreement"><i class="iconfont icon-checkbox J_read"><em>√</em></i>
                                            我已阅读
                                            <a href="https://api.jr.mi.com/insurance/document/phone_accidentIns.html?insuranceSku=22608&amp;couponFrom=rule" target="_blank">服务条款<span>|</span></a> <a href="https://api.jr.mi.com/insurance/document/phone_accidentIns.html?insuranceSku=22608&amp;couponFrom=question" target="_blank">常见问题</a>
                                        </p>
                    ...
                    <ul class="btn-wrap clearfix" id="J_buyBtnBox">
                        <li><a data-sign="disabled" data-type="bigtap" data-tip="" class="btn btn-biglarge btn-primary" href="javascript:void(0);" data-isbigtap="true" data-name="加入购物车">加入购物车</a></li>
                    ...
                    <div class="pro-policy" id="J_policy">
                        ...
                        <a href="javascript:void(0);" title="由小米发货的商品，单笔满150元免运费;由第三方商家发货的商品，免运费;特殊商品需要单独收取运费，具体以实际结算金额为准；优惠券等不能抵扣运费金额;"> <span class="support">  <i class="iconfont"></i>  <em>运费说明</em> </span> </a></div>
                    </div>
                <!-- 获取商品失败 -->
...
<script type="text/javascript">
    ...
    function initSpeDisplay(){
        ...
        for (var j = 0; j < name_group.length; j++) {
            if ($(name_group[j]).data("id") == $(name_group[j]).parent().data("id")) {
    ...
    $("li[data-index]").click(function () {
        $(this).parent().data("id", $(this).data("id").toString());
