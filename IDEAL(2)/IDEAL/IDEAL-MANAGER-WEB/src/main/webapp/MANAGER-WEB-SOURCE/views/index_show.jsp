...
<script>
    ...
    $.getJSON(url,data,function(result){
        ...
        for(var i=0;i<result.data.length;i++){
            console.log(result);
            var url = result.data[i].url+'?id='+result.data[i].id;
            console.log(url);
    ...
    $.getJSON(url,data,function(result){
        ...
        for(var i=0;i<result.data.length;i++){
            var r = t.replace("TitleDesc",result.data[i].titleDesc).replace("Title",result.data[i].title).replace("SubTitle",result.data[i].subTitle).replace("Content",result.data[i].content).replace("SRC",result.data[i].pic).replace("ID",result.data[i].id);
            var temple = $(r);
    ...
    var t =
        ...
        '<div class="sub_mingxing"><a href="HREF?id=ID"><img src="SRC" alt=""></a></div>'+
