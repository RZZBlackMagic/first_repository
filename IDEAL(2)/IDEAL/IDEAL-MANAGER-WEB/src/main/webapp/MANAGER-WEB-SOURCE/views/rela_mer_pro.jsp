    ...
    <div class="main">
        ...
        <div class="main-content">
            <div class="container-fluid">
                <h3 class="page-title">代理商-生产商 签约状态</h3>
                ...
                <div class="tpl-block">
                    ...
                    <div id="showTable">
                        <div id="toolbar">
                            ...
                            <button onclick="unAllowed()" id="" class="btn btn-default" type="button" style="float: left;border-top-right-radius: 0%;border-bottom-right-radius: 0%;">
                                显示未同意列表
                            </button>
                            <button onclick="allowed()" id="remove-good" class="btn btn-default" type="button" style="margin-right: 5px;float: left;border-top-left-radius: 0%;border-bottom-left-radius: 0%;border-left:0;">
                                显示已同意列表
                            </button>
                        </div>
...
<script>
    ...
    function initUnTable( ) {
        $("#table").bootstrapTable({
            url: "/manager/getUnRelaMerProListForTable/relaManager.do",       //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
            contentType: "application/x-www-form-urlencoded",
            dataType: "json",
            toolbar: '#toolbar',                //工具按钮用哪个容器
    ...
    function initTable( ) {
        $("#table").bootstrapTable({
            url: "/manager/getRelaMerProListForTable/relaManager.do",       //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
            contentType: "application/x-www-form-urlencoded",
            dataType: "json",
            toolbar: '#toolbar',                //工具按钮用哪个容器
