                                ...
                                <div class="panel panel-headline" style="min-height: 710px">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="pic2" name="pic2" type="file" class="form-control" placeholder="">
                                        </div>
                                        <div class="form-group">
    ...
    <div class="modal-dialog" style="width: 20%">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info" data-dismiss="modal" id="add-spe" onclick="clickCategorySubmit()">
                    提交
                </button>
            </div>
        </div><!-- /.modal-content -->
...
<script>
    ...
    $(function () {
        initTable("/portal/table/updateContentCategory.do", 1);
        $('#add-cat').editable({
    ...
    var url = '/portal/ztree/contentCategory.do';
    $.ajax({
        url: url,
        dataType: 'json',
        processData: false,
        ...
        callback: {
            ...
            beforeClick: function (treeId, treeNode) {
                ...
                if (treeNode.isParent) {
                    ...
                    initTable('/portal/table/updateContentCategory.do', treeNode.id);
                    $('#remove-good').unbind();
                    $('#submit').unbind();
                    $('#add-good').unbind();
    ...
    function clickContentSubmit() {
        ...
        var url = "/portal/content/addContent.do";
        var data = {
        ...
        $.post(url, data, function (result) {
            ...
            clickExit();
            $("#table").bootstrapTable('destroy');
            initContentTable('/portal/content/updateContent.do', $('#left').data('treeNodeId'));
        });
    ...
    function clickMinusContent() {
        ...
        var url = '/portal/table/deleteContent.do';
        var data = {
            id: id
        };
    ...
    function clickMinusCategory() {
        ...
        var url = '/portal/table/deleteContentCategory.do';
        var data = {
            'id': id,
            'name': name
        };
        $.post(url, data, function () {
            $("#table").bootstrapTable('destroy');
            initTable('/portal/table/updateContentCategory.do', $('#left').data('treeNodeId'));
        });
    ...
    function clickCategorySubmit() {
        ...
        var url = '/portal/table/addContentCategory.do';
        $.post(url, data, function (result) {
            $('input').val("");
            clickExit();
            $("#table").bootstrapTable('destroy');
    ...
    function initTable(edit_url, id) {
        ...
        $("#table").bootstrapTable({
            url: "/portal/table/contentCategory.do",       //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
    ...
    function initContentTable(edit_url, id) {
        $(table).data("id", id);
        $("#table").bootstrapTable({
            url: "/portal/table/content.do",       //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
            contentType: "application/x-www-form-urlencoded",
            dataType: "json",
            toolbar: '#toolbar',                //工具按钮用哪个容器
