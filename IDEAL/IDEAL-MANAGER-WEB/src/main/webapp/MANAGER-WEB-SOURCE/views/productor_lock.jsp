    ...
    <div class="main">
        ...
        <div class="main-content">
            <div class="container-fluid">
                <h3 class="page-title">违章用户处理</h3>

                <div class="tpl-block">

                    <div id="showTable">
                        <div id="toolbar">
                            <button onclick="clickMinus()" class="btn btn-default" type="button" style="margin-right: 5px;float: left;">
                                封号
                            </button>
                        </div>
...
<script>
    ...
    function initTable( ) {
        $("#table").bootstrapTable({
            url: "/manager/getAllowedProductorListForTable/productorManager.do",       //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
    ...
    function clickMinus(){
        ...
        var url = '/manager/clockProductor/producotManager.do';
