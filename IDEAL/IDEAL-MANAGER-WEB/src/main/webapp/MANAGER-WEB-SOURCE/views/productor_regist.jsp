                ...
                <div class="tpl-content-wrapper">
                    <div class="tpl-portlet-components">
                         <div class="tpl-block">
                            <div id="showTable">
                                <div id="toolbar">
                                    <button onclick="clickPlus()" id="add-good" class="btn btn-default" type="button" style="float: left;border-top-right-radius: 0%;border-bottom-right-radius: 0%;">
                                        <span class="fa fa-check" style="margin-right: 3px"></span>通过
                                    </button>
                                    <button onclick="clickMinus()" id="remove-good" class="btn btn-default" type="button" style="margin-right: 5px;float: left;border-top-left-radius: 0%;border-bottom-left-radius: 0%;border-left:0;">
                                        <span class="fa fa-close" style="margin-right: 3px"></span>删除
                                    </button>
                                </div>
...
<script>
    ...
    function initTable( ) {
        $("#table").bootstrapTable({
            url: "/manager/getProductorListForTable/productorManager.do",       //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
    ...
    function clickMinus(){
        ...
        var url = '/manager/deleteProductor/productorManager.do';
    ...
    function clickPlus(){
        ...
        var url = '/manager/editProductorStatus/productorManager.do';
