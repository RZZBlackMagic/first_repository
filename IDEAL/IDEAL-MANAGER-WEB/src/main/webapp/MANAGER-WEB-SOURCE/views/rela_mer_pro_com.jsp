...
<head>
    <title>代理商-生产商 商品状态</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">

    <!-- bootstarp-table相关css -->
    ...
    <div class="main">
        ...
        <div class="main-content">
            <div class="container-fluid">
                <h3 class="page-title">代理商-生产商 商品状态</h3>
                ...
                <div class="tpl-block">
                    ...
                    <div id="showTable">
                        <div id="toolbar">
                            ...
                            <button onclick="allowed()" id="-good" class="btn btn-default" type="button" style="float: left;border-top-right-radius: 0%;border-bottom-right-radius: 0%;">
                                显示通过列表
                            </button>
                            <button onclick="unAllowed()" id="remove-good" class="btn btn-default" type="button" style="margin-right: 5px;float: left;border-top-left-radius: 0%;border-bottom-left-radius: 0%;border-left:0;">
                                显示未通过列表
                            </button>
                        </div>
...
<script>
    ...
    // function initOrTable( ) {
    //     $("#table").bootstrapTable({
    //         url: "/manager/relaManager.do",       //请求后台的URL（*）
    //         method: 'get',                      //请求方式（*）
    ...
    function initTable( ) {
        $("#table").bootstrapTable({
            url: "/manager/getRelaProMerComListForTable/relaManager.do",       //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
            contentType: "application/x-www-form-urlencoded",
            dataType: "json",
            toolbar: '#toolbar',                //工具按钮用哪个容器
    ...
    function initUnTable( ) {
        $("#table").bootstrapTable({
            url: "/manager/getUnRelaProMerComListForTable/relaManager.do",       //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
            contentType: "application/x-www-form-urlencoded",
            dataType: "json",
            toolbar: '#toolbar',                //工具按钮用哪个容器
