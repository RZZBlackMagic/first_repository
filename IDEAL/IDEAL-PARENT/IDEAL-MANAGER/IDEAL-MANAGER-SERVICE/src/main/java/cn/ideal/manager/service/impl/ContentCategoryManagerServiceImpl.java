...
public class ContentCategoryManagerServiceImpl implements ContentCategoryManagerService {
    ...
    @Override
    public MessageResult updateContentCategory(CommodityContentCategory com) {
        com.setUpdated(new Date(System.currentTimeMillis()));
        commodityContentCategoryMapper.updateByPrimaryKeySelective(com);
    ...
    public MessageResult addContentCategory(CommodityContentCategory com) {
        commodityContentCategoryMapper.insert(new CommodityContentCategory(null, com.getParentId(), com.getName(), 0, 1, 0, new Date(System.currentTimeMillis()), new Date(System.currentTimeMillis())));
        return MessageResult.ok(true);
    }
