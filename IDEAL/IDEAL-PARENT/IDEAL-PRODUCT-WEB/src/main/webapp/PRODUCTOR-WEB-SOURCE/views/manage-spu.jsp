    ...
    <div class="main">
        ...
        <div class="main-content" style="">
            <div class="container-fluid">
                <h3 class="page-title">商品SPU管理</h3>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-headline">
                            <div class="panel-body">
                                <div id="toolbar">
                                    ...
                                    <%--</button></a>--%>
                                    <button id="remove-good" class="btn btn-default" type="button" style="margin-right: 5px;float: left;">
...
<script>
    ...
    function initTable() {
        $("#table").bootstrapTable({
            url: '/product/commodity/table',       //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
            ...
            columns: [
                ...
                },
                {
                    ...
                    formatter: function (value) {
                        ...
                        else if (value == 1) return "未上架";
                        else if (value == 2) return "已下架";
                        else if (value == 3) return "违规商品";
                        else return "未知状态";
                ...
                },
                {
                    ...
                    formatter: function (value, row, index) {
                        var result = "";
                        result += "<a href='manage-sku.html?id="+row.id+"' class='btn btn-xs' title='添加规格数据'><span class='glyphicon glyphicon-th-large'></span></a>";
                        return result;
                    }
                }
