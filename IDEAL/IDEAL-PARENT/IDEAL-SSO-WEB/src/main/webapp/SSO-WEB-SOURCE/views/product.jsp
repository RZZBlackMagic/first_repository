...
<body>
    ...
    <div class="form">
        ...
        <form class="register-form">
            ...
            <input type="text" id="reg-type" placeholder="公司类别">
            <input type="text" id="reg-mainbusiness" placeholder="主营">
            <input type="text" id="reg-turnover" placeholder="年营业额">
            <button id="product-register">注册</button>
        ...
        <form class="login-form">
            ...
            <select id="type" style="width: 100%;border: 0;margin: 0 0 15px;padding: 15px;background: #f2f2f2;border-radius: 3px;box-sizing: border-box;font-size: 14px;appearance:none; -moz-appearance:none; -webkit-appearance:none;">
                ...
                <option value="PRODUCT" selected>生产商</option>
                <option value="MERCHANT">代理商</option>
            </select>
    ...
    <script>
        ...
        $("#product-register").click(function () {
            if ($("#reg-username").val()&&$("#reg-pwd").val()&&$("#reg-phone").val()&&$("#reg-email").val()&&$("#reg-mainbusiness").val()&&$("#reg-type").val()&&$("#reg-turnover").val()){
                $.ajax({
                    type: "post",
                    url: "/sso/product/register",
                    data: {
                        username: $("#reg-username").val(),
                        password: $("#reg-pwd").val(),
                        phone:$("#reg-phone").val(),
                        email:$("#reg-email").val(),
                        mainbusiness:$("#reg-mainbusiness").val(),
                        type:$("#reg-type").val(),
                        turnover:$("#reg-turnover").val()
