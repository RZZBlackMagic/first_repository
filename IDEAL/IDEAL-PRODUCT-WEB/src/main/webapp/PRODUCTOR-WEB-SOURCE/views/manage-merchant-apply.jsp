                    ...
                    <div class="col-md-12">
                        <div class="panel panel-headline">
                            <div class="panel-body">
                                <div id="toolbar">
                                    <button id="agree" class="btn btn-default" title="通过" type="button" style="float: left;border-top-right-radius: 0%;border-bottom-right-radius: 0%;">
                                        <span class="fa fa-check" ></span>
                                    </button>
                                    <button id="disagree" class="btn btn-default" title="拒绝" type="button" style="margin-right: 5px;float: left;border-top-left-radius: 0%;border-bottom-left-radius: 0%;border-left:0;">
...
<script>
    ...
    function initTable() {
        $("#table").bootstrapTable({
            url: '/product/table/merchant_apply',       //请求后台的URL（*）
            method: 'post',                      //请求方式（*）
