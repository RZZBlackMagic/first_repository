...
<div class="site-header site-mini-header">
    <div class="container">
        <div class="header-logo">
            <a  href="#" style="width:100px"><img src="assets/image/logo_top.png" style="width: 50px;height: 50px;"></a>
        </div>
...
<script>
    ...
    function add(){
        ...
        $(this).parent().parent().find('input[class="goods-num J_goodsNum"]').attr('value',num);
        //改变当前商品小计
