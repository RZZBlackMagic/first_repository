            ...
            <div class="pro-info span10">
                ...
                <div class="J_main">
                    ...
                    <ul class="btn-wrap clearfix" id="J_buyBtnBox">
                        <li><a data-sign="disabled" data-type="bigtap" data-tip="" class="btn btn-biglarge btn-primary" onclick="addToCart()"  data-isbigtap="true" data-name="加入购物车">加入购物车</a></li>
                        <li onclick="purchase()"><a  href="cart.html" class="btn-gray btn-like btn-biglarge">立即购买 </a></li>
                    </ul>
