...
<head>
    ...
    <style>
        *{
        ...
        #main .main-container #title .class-box{
            margin-top: 20px;
        }
        #main .main-container #title .class-box label{
            float: left;
            line-height: 40px;
            margin-right: 15px;
            margin-left: 15px;
        }
        #main .main-container #title .class-box #class{
            width: 20%;
            height: 40px;
            border-radius: 5px;
            background-color: #eff2f3;
        ...
        #main .main-container #title .times-box{
            margin-top: 20px;
        }
        #main .main-container #title .times-box label{
            float: left;
            line-height: 40px;
            margin-right: 15px;
            margin-left: 15px;
        }
        #main .main-container #title .times-box #times{
            width: 10%;
            height: 40px;
            border-radius: 5px;
            background-color: #eff2f3;
                ...
                <!-- <form action="#" method="post">
                    <div class="course-box">
                        ...
                        <select name="course" id="course">
                            <option value="all_course" selected>所有课程</option>
                    ...
                    <div class="class-box">
                        ...
                        <select name="class" id="class">
                            <option value="all_class" selected>所有班级</option>
                            <option value="class_1">班级1</option>
                        </select>
                    </div>
                    <div class="times-box">
                        <label for="class">选择第几次考勤记录:</label>
                        <select name="times" id="times">
                            <option value="all_times" selected>所有记录</option>
                            <option value="times_1">第一次</option>
                        </select>
                    </div>
