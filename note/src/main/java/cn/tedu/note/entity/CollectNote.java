...
public class CollectNote {
	...
	public CollectNote(String cn_share_id, String cn_share_title, String cn_share_body, String cn_note_id,
			String cn_user_id) {
		super();
	...
	public String toString() {
		return "CollectNote [cn_share_id=" + cn_share_id + ", cn_share_title=" + cn_share_title + ", cn_share_body="
				+ cn_share_body + ", cn_note_id=" + cn_note_id + ", cn_user_id=" + cn_user_id + "]";
	}
